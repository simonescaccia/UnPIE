...
from utils.graph_utils import normalized_adjacency
...
class UnPIESTGCN(tf.keras.Model):
    ...
    def __init__(self, input_dim, middle_dim, emb_dim):
        ...
        self.STGCN_layers.append(STGCN(middle_dim, stride=2, downsample=True))
        self.STGCN_layers.append(STGCN(middle_dim))
        self.STGCN_layers.append(STGCN(emb_dim, stride=2, downsample=True))
